...
public class AppointmentController {
    ...
    public ResponseEntity<?> createOrUpdateAppointment(@RequestBody Appointment appointment) {
        try {
            // Validaciones adicionales según las especificaciones de JUnit
            if (appointment.getDate() == null || appointment.getDescription() == null || appointment.getLocation() == null) {
                return new ResponseEntity<>("Falta información requerida para crear la cita.", HttpStatus.BAD_REQUEST);
            }
